                ...
                <div className="mt-16 space-y-20 px-4 md:px-0">
                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:space-x-10">
                        ...
                        <div className="w-full lg:w-1/2 mt-6 lg:mt-0 text-gray-600 text-center lg:text-left lg:px-16">
                            ...
                            <p className="mt-4">
                                A dynamic and responsive web application that allows users to search and explore trending GIFs in real-time using the Giphy API. Built with React, Vite, and Tailwind CSS, the app features fast performance, responsive design, and intuitive user interactions.
                            </p>
                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:space-x-10">
                        <div className="w-full lg:w-1/2 flex justify-center">
                            <img className="h-52 lg:h-80" src="https://i.ibb.co/BTTs68g/Blog.png" alt="Blog Application" />
                        </div>
                        <div className="w-full lg:w-1/2 mt-6 lg:mt-0 text-gray-600 text-center lg:text-left lg:px-16">
                            ...
                            <button onClick={() => navigate('/project-2')} className="inline-block px-6 py-2 mt-4 bg-violet-600 rounded-lg text-white">Project Detail</button>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:space-x-10">
                        <div className="w-full lg:w-1/2 flex justify-center">
                            <img className="h-52 lg:h-80" src="https://i.ibb.co/GkX5mBL/Todo.png" alt="Todo Web App" />
                        </div>
                        <div className="w-full lg:w-1/2 mt-6 lg:mt-0 text-gray-600 text-center lg:text-left lg:px-16">
                            ...
                            <button onClick={() => navigate('/project-3')} className="inline-block px-6 py-2 mt-4 bg-violet-600 rounded-lg text-white">Project Detail</button>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:space-x-10 ">
                        <div className="w-full lg:w-1/2 flex justify-center">
                            <img className="h-52 lg:h-80" src="https://i.ibb.co/cFX6hQK/currency-Converter.png" alt="Currency Converter" />
                        </div>
                        <div className="w-full lg:w-1/2 mt-6 lg:mt-0 text-gray-600 text-center lg:text-left lg:lg:px-16">
                            ...
                            <button onClick={() => navigate('/project-5')} className="inline-block px-6 py-2 mt-4 bg-violet-600 rounded-lg text-white">Project Detail</button>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:space-x-10">
                        <div className="w-full lg:w-1/2 flex justify-center">
                            <img className="h-52 lg:h-80" src="https://i.ibb.co/x6Dtx8s/Tic-Tac-Toe.png" alt="Tic Tac Toe Game" />
                        </div>
                        <div className="w-full lg:w-1/2 mt-6 lg:mt-0 text-gray-600 text-center lg:text-left lg:px-16">
                            ...
                            <button onClick={() => navigate('/project-4')} className="inline-block px-6 py-2 mt-4 bg-violet-600 rounded-lg text-white">Project Detail</button>
                        </div>
                    </div>
